...
IContentMetaDatabase::IContentMetaDatabase(NcmContentMetaDatabase &&storage)
    : m_db(storage), open(true) {}

IContentMetaDatabase::IContentMetaDatabase(IContentMetaDatabase &&storage)
    : m_db(storage.m_db), open(storage.open) {
    storage.m_db = {};
    storage.open = false;
}
